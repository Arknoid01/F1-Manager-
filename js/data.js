...
const F1Data = {
  ...
  // ── CIRCUITS ──────────────────────────────────────────────
  circuits: [
    { id:'bahrain',     name:'Bahrain',     fullName:'Bahrain International Circuit',        laps:57, lapDistance:5.412, baseLapTime:93.5,  pitLoss:22, overtakingDifficulty:0.40, tyreDegradation:1.20, drsZones:2, fuelPerLap:1.8, rainChance:0.02, dryingRate:8.0, trackTemp:35 },
    { id:'jeddah',      name:'Jeddah',      fullName:'Jeddah Corniche Circuit',               laps:50, lapDistance:6.174, baseLapTime:90.5,  pitLoss:21, overtakingDifficulty:0.42, tyreDegradation:0.95, drsZones:3, fuelPerLap:2.1, rainChance:0.03, dryingRate:9.0, trackTemp:38 },
    { id:'melbourne',   name:'Australie',   fullName:'Albert Park Circuit',                   laps:58, lapDistance:5.278, baseLapTime:80.8,  pitLoss:20, overtakingDifficulty:0.55, tyreDegradation:1.00, drsZones:4, fuelPerLap:1.8, rainChance:0.25, dryingRate:5.0, trackTemp:28 },
    { id:'imola',       name:'Imola',       fullName:'Autodromo Enzo e Dino Ferrari',          laps:63, lapDistance:4.909, baseLapTime:78.5,  pitLoss:25, overtakingDifficulty:0.72, tyreDegradation:0.90, drsZones:1, fuelPerLap:1.6, rainChance:0.28, dryingRate:4.5, trackTemp:22 },
    { id:'miami',       name:'Miami',       fullName:'Miami International Autodrome',          laps:57, lapDistance:5.412, baseLapTime:91.1,  pitLoss:22, overtakingDifficulty:0.50, tyreDegradation:1.15, drsZones:3, fuelPerLap:1.9, rainChance:0.2, dryingRate:6.0, trackTemp:32 },
    { id:'monaco',      name:'Monaco',      fullName:'Circuit de Monaco',                     laps:78, lapDistance:3.337, baseLapTime:75.0,  pitLoss:28, overtakingDifficulty:0.95, tyreDegradation:0.70, drsZones:1, fuelPerLap:1.2, rainChance:0.3, dryingRate:3.5, trackTemp:26 },
    { id:'canada',      name:'Canada',      fullName:'Circuit Gilles-Villeneuve',              laps:70, lapDistance:4.361, baseLapTime:74.0,  pitLoss:19, overtakingDifficulty:0.35, tyreDegradation:1.05, drsZones:3, fuelPerLap:1.55, rainChance:0.22, dryingRate:4.0, trackTemp:24 },
    { id:'barcelona',   name:'Espagne',     fullName:'Circuit de Barcelona-Catalunya',         laps:66, lapDistance:4.657, baseLapTime:78.8,  pitLoss:22, overtakingDifficulty:0.62, tyreDegradation:1.35, drsZones:2, fuelPerLap:1.7, rainChance:0.12, dryingRate:6.5, trackTemp:30 },
    { id:'austria',     name:'Autriche',    fullName:'Red Bull Ring',                          laps:71, lapDistance:4.318, baseLapTime:66.4,  pitLoss:19, overtakingDifficulty:0.28, tyreDegradation:1.05, drsZones:3, fuelPerLap:1.45, rainChance:0.45, dryingRate:4.0, trackTemp:22 },
    { id:'silverstone', name:'Silverstone', fullName:'Silverstone Circuit',                   laps:52, lapDistance:5.891, baseLapTime:89.5,  pitLoss:21, overtakingDifficulty:0.45, tyreDegradation:1.40, drsZones:2, fuelPerLap:2.0, rainChance:0.35, dryingRate:3.5, trackTemp:22 },
    { id:'hungary',     name:'Hongrie',     fullName:'Hungaroring',                            laps:70, lapDistance:4.381, baseLapTime:78.0,  pitLoss:21, overtakingDifficulty:0.82, tyreDegradation:1.25, drsZones:1, fuelPerLap:1.55, rainChance:0.25, dryingRate:5.0, trackTemp:30 },
    { id:'spa',         name:'Spa',         fullName:'Circuit de Spa-Francorchamps',           laps:44, lapDistance:7.004, baseLapTime:106.0, pitLoss:24, overtakingDifficulty:0.35, tyreDegradation:1.10, drsZones:2, fuelPerLap:2.2, rainChance:0.48, dryingRate:3.0, trackTemp:20 },
    { id:'zandvoort',   name:'Pays-Bas',    fullName:'Circuit Zandvoort',                      laps:72, lapDistance:4.259, baseLapTime:71.5,  pitLoss:20, overtakingDifficulty:0.75, tyreDegradation:1.18, drsZones:2, fuelPerLap:1.45, rainChance:0.3, dryingRate:3.5, trackTemp:22 },
    { id:'monza',       name:'Monza',       fullName:'Autodromo Nazionale Monza',              laps:53, lapDistance:5.793, baseLapTime:82.5,  pitLoss:23, overtakingDifficulty:0.30, tyreDegradation:0.90, drsZones:2, fuelPerLap:1.9, rainChance:0.2, dryingRate:5.5, trackTemp:28 },
    { id:'baku',        name:'Azerbaïdjan', fullName:'Baku City Circuit',                      laps:51, lapDistance:6.003, baseLapTime:103.0, pitLoss:20, overtakingDifficulty:0.25, tyreDegradation:0.82, drsZones:2, fuelPerLap:2.0, rainChance:0.08, dryingRate:7.0, trackTemp:32 },
    { id:'singapore',   name:'Singapour',   fullName:'Marina Bay Street Circuit',              laps:62, lapDistance:4.940, baseLapTime:95.0,  pitLoss:27, overtakingDifficulty:0.78, tyreDegradation:1.28, drsZones:3, fuelPerLap:1.75, rainChance:0.41, dryingRate:4.0, trackTemp:32 },
    { id:'suzuka',      name:'Suzuka',      fullName:'Suzuka International Racing Course',     laps:53, lapDistance:5.807, baseLapTime:91.0,  pitLoss:22, overtakingDifficulty:0.60, tyreDegradation:1.15, drsZones:1, fuelPerLap:1.9, rainChance:0.41, dryingRate:4.5, trackTemp:26 },
    { id:'qatar',       name:'Qatar',       fullName:'Lusail International Circuit',           laps:57, lapDistance:5.419, baseLapTime:84.0,  pitLoss:24, overtakingDifficulty:0.58, tyreDegradation:1.55, drsZones:1, fuelPerLap:1.85, rainChance:0.01, dryingRate:10.0, trackTemp:38 },
    { id:'cota',        name:'États-Unis',  fullName:'Circuit of the Americas',                laps:56, lapDistance:5.513, baseLapTime:97.0,  pitLoss:22, overtakingDifficulty:0.48, tyreDegradation:1.20, drsZones:2, fuelPerLap:1.9, rainChance:0.22, dryingRate:5.5, trackTemp:30 },
    { id:'mexico',      name:'Mexique',     fullName:'Autódromo Hermanos Rodríguez',           laps:71, lapDistance:4.304, baseLapTime:78.8,  pitLoss:20, overtakingDifficulty:0.38, tyreDegradation:0.95, drsZones:3, fuelPerLap:1.5, rainChance:0.15, dryingRate:5.0, trackTemp:28 },
    { id:'brazil',      name:'Brésil',      fullName:'Interlagos',                             laps:71, lapDistance:4.309, baseLapTime:71.6,  pitLoss:20, overtakingDifficulty:0.33, tyreDegradation:1.20, drsZones:2, fuelPerLap:1.45, rainChance:0.45, dryingRate:3.5, trackTemp:26 },
    { id:'vegas',       name:'Las Vegas',   fullName:'Las Vegas Strip Circuit',                laps:50, lapDistance:6.201, baseLapTime:94.0,  pitLoss:21, overtakingDifficulty:0.32, tyreDegradation:0.78, drsZones:2, fuelPerLap:2.05, rainChance:0.04, dryingRate:9.0, trackTemp:18 },
    { id:'abudhabi',    name:'Abu Dhabi',   fullName:'Yas Marina Circuit',                     laps:58, lapDistance:5.281, baseLapTime:87.5,  pitLoss:22, overtakingDifficulty:0.52, tyreDegradation:0.98, drsZones:2, fuelPerLap:1.85, rainChance:0.02, dryingRate:9.5, trackTemp:36 },
  ],
